...
func (m *MockGameServersRepository) AddGameServer(ctx context.Context, userID entity.UserID, ip net.IP, port uint32, rconPassword, displayName string, isPublic bool) error {
	m.ctrl.T.Helper()
...
func (m *MockMatchesRepository) AddMatch(ctx context.Context, userID entity.UserID, serverID entity.GameServerID, team1ID, team2ID entity.TeamID, startTime, endTime time.Time, maxMaps int32, title string, skipVeto bool, apiKey string) error {
	m.ctrl.T.Helper()
...
func (m *MockTeamsRepository) AddTeam(ctx context.Context, userID entity.UserID, name, tag, flag, logo string) error {
	m.ctrl.T.Helper()
...
func (m *MockPlayersRepository) AddPlayer(ctx context.Context, teamID entity.TeamID, steamID entity.SteamID, name string) error {
	m.ctrl.T.Helper()
