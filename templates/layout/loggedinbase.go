...
// Should edit source file and re-generate: templates/layout/loggedinbase.gohtml
...
// Loggedinbase generates templates/layout/loggedinbase.gohtml
func Loggedinbase(body string) string {
	...
	RenderLoggedinbase(&_b, _body)
	return _b.String()
}

// RenderLoggedinbase render templates/layout/loggedinbase.gohtml
func RenderLoggedinbase(_buffer io.StringWriter, body func(_buffer io.StringWriter)) {
